...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    roles: ['super_admin'],
    intro: "EduSuivi gère plusieurs écoles indépendantes. Le super administrateur crée et supervise les écoles, et est par défaut administrateur de chacune d'entre elles ; chaque école peut aussi avoir son propre administrateur dédié, qui ne voit que les données de son établissement.",
    etapes: [
      "Cliquez sur « + Nouvelle école » : renseignez le nom, la ville, le pays, un téléphone/email de contact, et éventuellement un email et un téléphone d'alerte dédiés (utilisés pour les notifications de demandes de code parent — sinon les valeurs par défaut de la plateforme sont utilisées).",
      "Cliquez « ✏️ Modifier » sur une école pour changer son nom, sa ville, son pays ou son téléphone à tout moment.",
      "Le nombre d'élèves inscrits dans chaque école s'affiche directement sur sa fiche (🎓).",
      "Cliquez « 🏢 Gérer cette école → » pour entrer directement dans le tableau de bord de cette école, avec les mêmes droits que son administrateur (classes, élèves, points, codes parents...). Un bandeau « ↩️ Retour Super Admin » reste affiché dans le menu pour revenir à la supervision multi-écoles à tout moment.",
      "Pour chaque école, cliquez « + Admin » pour créer en plus un compte administrateur dédié (prénom, nom, email, mot de passe d'au moins 8 caractères), si vous ne voulez pas être le seul à la gérer.",
    ...
    astuce: "Le compte super administrateur n'est rattaché à aucune école par défaut, mais peut entrer dans la gestion de n'importe laquelle via « Gérer cette école » — il agit alors exactement comme l'administrateur de cet établissement.",
  },
  {
    id: 'tableau_de_bord',
    icon: '📊',
